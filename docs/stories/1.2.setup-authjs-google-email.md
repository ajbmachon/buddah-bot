...
- [x] Task 3: Create custom login page with dual auth options (AC: 6)
  ...
  - [x] Style login page with Tailwind (centered card, BuddhaBot branding)
...
2. Create new project: "BuddhaBot"
3. Enable Google+ API
...
- Add BuddhaBot branding (logo, tagline)
...
- Root layout metadata updated to reflect BuddhaBot branding
