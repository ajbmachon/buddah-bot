...
- [x] Task 1: Connect project to Vercel (AC: 1)
  ...
  - [x] Select "buddha-bot" repository
...
- [x] Task 3: Update Google OAuth callback URLs for production (AC: 3)
  ...
  - [x] Edit OAuth 2.0 Client ID for BuddhaBot
...
AUTH_GOOGLE_SECRET=...
RESEND_API_KEY=...
EMAIL_FROM=noreply@buddhabot.local
NOUS_API_BASE_URL=https://api.nousresearch.com/v1
NOUS_API_KEY=...
HERMES_MODEL=Hermes-4-405B

# Production (Vercel Dashboard - NOT in git)
NEXTAUTH_URL=https://buddha-bot-abc123.vercel.app
...
EMAIL_FROM=noreply@buddhabot.com
NOUS_API_BASE_URL=https://api.nousresearch.com/v1
...
https://buddha-bot-abc123.vercel.app/api/auth/callback/google  # Production
```
...
- Epic 3: Add conversation history persistence (AssistantCloud)
