...
2. Project created in AssistantCloud dashboard with name `buddah-bot`
...
- [ ] Task 1: Create AssistantCloud account and project (AC: 1, 2)
  ...
  - [ ] Create new project named `buddah-bot`
...
- [ ] Task 4: Create basic connection test (AC: 5)
  ...
  - [ ] Create instance with Auth.js integration pattern
...
- [ ] Task 6: Document AssistantCloud setup
  ...
  - [ ] Document authenticated mode (Auth.js integration)
...
**Use Case:** BuddahBot MVP (friends & family with Google accounts)
